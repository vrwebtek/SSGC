              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open_multipart('admin/registration_service_action/update','class="form-horizontal form-label-left"','data-parsley-validate');?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="rstext" name="rstext" value="<?php echo $name; ?>" required class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12 col-sm-6 col-xs-12">
                          <textarea name="rsbody"><?php echo $body; ?></textarea>
                          <?php echo $error;?>
                        </div>
                      </div>
