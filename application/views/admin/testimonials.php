              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo form_open_multipart('admin/testimonial_action/new','class="form-horizontal form-label-left"','data-parsley-validate');?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="photo" name="photo" required class="form-control col-md-7 col-xs-12">
                          <?php echo $error;?>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-md-12 col-sm-6 col-xs-12">
                          <textarea name="testimonial" placeholder="Write the testimonial here"></textarea>
                          <?php echo $error;?>
                        </div>
                      </div>
