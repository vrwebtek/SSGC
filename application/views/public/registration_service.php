                     ...
                     <ul>
                        <?php
                        	...
                        	foreach($other_offering as $oo)
							{
								...
								{
									?>
                                    <li style="text-align: left;padding-left: 24px;float:left;width:75%;"><a href="<?php echo site_url("page/load_registration_services/".$oo['slug']); ?>" style="display: block;font-size: 10px; font-weight:bold"><?php echo $oo['name']; ?></a><div class="bottom_highlight"></div></li>
                                    <?php
								}
								else{
								?>
                               
                                	<li style="text-align: left;padding-left: 24px;float:left;width:75%;"><a href="<?php echo site_url("page/load_registration_services/".$oo['slug']); ?>" style="display: block;font-size: 11px;"><?php echo $oo['name']; ?></a><div class="bottom_highlight"></div></li>
