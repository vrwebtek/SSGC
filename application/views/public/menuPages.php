                        ...
                        <?php
                        	...
                        	foreach($ql as $q)
							{
								...
								?>
                                	...
                                	<li style="text-align: left;padding-left: 24px;float:left;width:75%;"><a href="<?php echo site_url($mmenu_slug."/other-services/".$q['slug']); ?>" style="display: block;font-size: 11px;"><?php echo $q['quick_link']; ?></a><div class="bottom_highlight"></div></li>
